...
final class ReferencesControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'reference[code_annonce]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setCode_annonce('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'reference[code_annonce]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getCode_annonce());
    }
